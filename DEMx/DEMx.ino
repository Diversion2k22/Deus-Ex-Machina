...
void setup(){
      ...
      pinMode(ir4, INPUT);
      pinMode(ir5, INPUT); 
      Serial.println("A=Auto mode, F=Forward, B=Backward, L=Left, R=Right, I=Forward-Right, G=Forward-Left, J=Backward-Right, H=Backward-Left, S=Stop Robot, W=Light On, w=Light Off, D=Light Effects");
}
